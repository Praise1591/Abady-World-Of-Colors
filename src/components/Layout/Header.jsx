            ...
            <div className="flex items-center justify-between">
                ...
                <div className='flex-1 max-w-md mx-8'>
                    <div className='relative'>
                        ...
                        <input type="text" placeholder='Search Anything' className='w-full pl-10 pr-4 py-2.5 bg-slate-100 dark:bg-slate-800 border border-slate-200  dark:border-slate-700 rounded-xl text-slate-800 dark:tex-white placeholder:bg-slate-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all' />
                ...
                <div className='flex items-center space-x-3'>
                    ...
                    {/* Notification */}
                    <button className='relative p-2.5 rounded-xl text-slate-600 dark:text-slate-300 hover:bg-slate-800 transition-colors'>
                    ...
                    {/* User Profile */}
                    <div className='flex items-center space-x-3 pl-3 border-l border-b-slate-200 dark:border-slate-700'>
